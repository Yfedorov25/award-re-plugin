...
/* ---- матчинг дерев: сигнатура tag + класи∩(архів∩живе) + текст.
   Симетричний перетин: класи, які рантайм ДОДАЄ живому (is-inited,
   --ready…) АБО ЗНІМАЄ з нього (is-invisible--js), відпадають з
   сигнатури автоматично — субдерева не випадають мовчки. ---- */
...
function makeSig(archiveTree, liveTree) {
...
function matchTrees(a, b, path, out, sig) {
