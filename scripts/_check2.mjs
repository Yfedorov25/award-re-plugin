...
const o='/private/tmp/claude-501/-Users-yehorfedorov-Downloads-KAI/c3be139d-c516-47c2-a8d3-42fb9aeac5b3/scratchpad/polish';
import('fs').then(fs=>fs.mkdirSync(o,{recursive:true}));
for(const [k,p] of Object.entries({runners:0.82, place:0.70})){
