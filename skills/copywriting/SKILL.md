---
name: copywriting
description: "Copywriting in the Fedoriv voice: live conversational sentences, free length, multiple hero variants, hard antislop filter (zero em-dash), RE niche register."
...
## v1 READ-GATE (закон E12)
Перед ПЕРШИМ рядком копі прочитай: всі 10 файлів references/ + `references/bans.yaml`.
Здача копі = повні секвенції в чаті (E10) + самоперевірка grep-ом по bans.yaml.
Тон актів сайту — один, з мета-патерну експозиції (_GRAMMAR.md): іменник-стан /
іменник-місце / імператив / сентенція / фраза-глава.
