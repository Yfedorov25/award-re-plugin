...
> Поглиблено VI-grounded. 2026-06-09. Споріднено: [PB_media](../../re-media/references/PB_media) [PB_typography](PB_typography.md) [PB_color](../../re-color/references/PB_color.md) [D_SilverPinewood_architecture](../../re-architecture/references/D_SilverPinewood_architecture.md).
...
- **aspect-ratio-слот дисципліна** ★ (з [PB_media](../../re-media/references/PB_media)): кожен медіа-слот має locked `aspect-ratio` → плейсхолдер тримає місце (0 CLS) + сітка передбачувана.
...
```
Усі відступи кратні базовому кроку (8/16/24/32/48/64/96/128). Parallax/transform значення — теж calc() від токенів (узгодженість з [PB_motion_score](../../motion-score/references/PB_motion_score)).
...
- Чергування media-left/media-right слайд-до-слайду (з [P_realestate](../../re-sections/references/P_realestate.md) rhythm).
