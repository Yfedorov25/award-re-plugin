...
| **Разом T-ID** | **109** | + 22 архетипи A-01…A-22 |
...
6. **Мобільна поведінка = 0 T-ID по всіх сайтах** — жоден тірдаун не фіксує touch/mobile варіанти прийомів (у REG лише модифікатори enable-mq/mobile-smooth). Системна діра.
