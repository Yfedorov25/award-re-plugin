...
> Vide Infra «quiet luxury», тепла крем-палітра. Живий зонд curl, 2026-06-09. Доповнює [D_SilverPinewood](../../teardowns/references/D_SilverPinewood.md) + [PB_interactive_map](../../re-interactive-map/references/PB_interactive_map) + [PB_site_architecture](PB_site_architecture).
