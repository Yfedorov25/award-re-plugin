...
> Переписано з живого зонду 5 VI. 2026-06-09. Споріднено: [[PB_site_architecture]] [[PB_forms_lead_capture]] [[P_realestate]] [[D_Springs_architecture]] [[copywriting]].
...
- Деталі форми/consent/доставка ліда → [[PB_forms_lead_capture]].
...
4. Форма/модалка: name + phone + PDPL-consent (мінімум полів). → [[PB_forms_lead_capture]].
...
## 4. НОРМИ
Заголовок великий (апекс типографіки), але довжина копі ВІЛЬНА (не жорсткий ліміт слів — [[PB_discovery_strategy]] §6). 1 CTA (макс 2). Кнопка full-width на мобілі.
...
## 6. ЧЕК
☐ остання секція, ui-dark ☐ ОДНА дія «Замовити дзвінок» ☐ копі ехоїть hero (закриває коло) ☐ кілька варіантів копі → найсильніший, antislop ☐ solid warm-accent кнопка (контраст з outline вище) ☐ форма мінімальна + PDPL-consent + currentPageLink ([[PB_forms_lead_capture]]) ☐ smooth fade-rise reveal ☐ мобіл full-width, без магніту.
