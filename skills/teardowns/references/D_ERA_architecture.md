...
> Фокус: СКІЛЬКИ сторінок, СКІЛЬКИ секцій, ЯК повʼязані. Доповнює [PB_visual_search](../../re-visual-search/references/PB_visual_search) + [PB_site_architecture](../../re-architecture/references/PB_site_architecture).
