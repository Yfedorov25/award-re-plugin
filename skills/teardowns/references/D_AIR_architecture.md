...
> Доповнює D_AIR_location (окремого файла нема — локація розібрана в D_AIR_architecture і D_AIR_video) (карта) + [PB_visual_search](../../re-visual-search/references/PB_visual_search) + [PB_site_architecture](../../re-architecture/references/PB_site_architecture).
