...
meaning:
  ...
  lands: "Сторінка веде з неба на землю: заголовок розведений як подих, дрон сідає на район і в момент посадки місто проступає кольоровими плямами життя, а нижче та сама земля стає чорною калькою з маршрутами до кожної точки."
source:
