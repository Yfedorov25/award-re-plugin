...
acceptance:
  ...
  - "select(id) draws the Dijkstra route along data.pois[].route via stroke-dashoffset, a walker rides getPointAtLength, and a live badge counts minutes up to walk; clicking the active POI or the map background clears it"
