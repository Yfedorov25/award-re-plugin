...
meaning:
  what: "Брендовий ритуал входу AIR (T-524): фіксований оверлей з КОНВОЄМ ЛІТЕР wordmark: кожна літера на повноширинній прозорій смузі їде своєю швидкістю (перша: p_half+76.6%, середні: інтерпольовані офсети, остання: 0) і вони СХОДЯТЬСЯ в розведений бренд-рядок на всю ширину (spread-мотив hero/футер T-311) + прогрес-бар 2px. min-delay 1500ms (= data-атрибут AIR). На готовності: вихід оверлея 2s cubic-bezier(.7,0,.3,1) СИНХРОННО з «роз'їздом панелей» — хедер в'їжджає згори (−100%→0), низ сторінки знизу (+100%→0), текст осідає з +20px. Один bezier на всі стадії. Знято дослівно з живого global.css aircenter.space."
...
source:
  grammar: "AIR T-524: конвой = .preloader__content-logo--1/2/3, у DOM це ОКРЕМІ SVG-ЛІТЕРИ A/I/R на повноширинних полотнах 1420×140 (моб 350×80) зі зсувами 76.6/38.5/0; бар = .preloader__progress; min-delay 1500, вихід = .animation--fade-out 2s, вхід = .animation--preloader-top-in/-bottom-in/-text-in (−100% / +100% / 20px, 2s той самий bezier) — знято з живого global.css 2026-07-06; мобільне підтвердження = D_AIR_mobile_video pre-01..30 («zoom-тикер wordmark, 3 проходи»)"
...
acceptance:
  - "конвой = ОКРЕМІ ЛІТЕРИ wordmark на повноширинних смугах (DOM AIR: logo--1/2/3 = букви A/I/R), офсети 76.6→0 + p_half першої — сходяться в РОЗВЕДЕНИЙ рядок на p=1; формули живого CSS дослівно"
