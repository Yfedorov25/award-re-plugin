...
overrides:
  layout: "панелі ЛАНДШАФТНІ 54vw 1.75 (живі фото 840×480), gap 10px; центр-фото домінує, сусіди визирають (фікс-кол 1: 44vw читались «рядком карток»)"
  skew: "CSS-переклад WebGL-кривизни: perspective(1100px) rotateY на ВНУТРІШНЬОМУ .cfc-panel-img; скіс БЕЗПЕРЕРВНИЙ ПОЗИЦІЙНИЙ (rAF від центру в'юпорта, IO-гейтований; фікс-кол 1 2026-07-06) — панель гнеться пропорційно відстані ПІД ЧАС руху рейки, як WebGL; caption-градієнт бази глушиться"
